...
cd /data/psychology/experiment_server && sh restart.sh experiment_server &> /dev/null 2>&1 &


ssh ahan "sudo rm -rf /data/psychology/experiment_server/experiment_server &> /dev/null" && \
scp bin/experiment_server ahan:/data/psychology/experiment_serverexperiment_server && \
...
ssh musk "sudo rm -rf /data/psychology/experiment_server/experiment_server &> /dev/null" && \
